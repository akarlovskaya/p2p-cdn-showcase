...
describe("Summary Component", () => {
  ...
  it("displays total earnings for provider role", () => {
    render(<Summary userRole="provider" total={2000} currentMonth="April" />);

    expect(screen.getByText("Total Earnings in April")).toBeInTheDocument();
  ...
  it("formats the total amount correctly", () => {
    render(
      <Summary userRole="client" total={1234567.89} currentMonth="April" />
    );
  ...
  it("displays zero total correctly", () => {
    render(<Summary userRole="provider" total={0} currentMonth="April" />);
